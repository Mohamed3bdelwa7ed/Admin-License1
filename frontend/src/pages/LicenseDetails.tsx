    ...
    <div>
      <div className="mb-5 flex flex-wrap items-start justify-between gap-3">
        <div>
          <button
            ...
            className="mb-2 inline-flex cursor-pointer items-center gap-1.5 text-xs font-medium text-gray-500 hover:text-gray-800"
          >
            <ArrowLeft size={13} /> Back to licenses
          </button>
          <div className="flex flex-wrap items-center gap-3">
            <h1 className="font-mono text-lg font-semibold tracking-tight text-gray-900">{license.licenseKey}</h1>
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-3">
        <Card title="License Information">
          ...
          {license.notes && (
            <div className="mt-3 rounded-md border border-gray-100 bg-gray-50 px-3 py-2.5">
              <p className="text-xs font-medium tracking-wide text-gray-500 uppercase">Notes</p>
              <p className="mt-1 text-sm text-gray-700">{license.notes}</p>
            </div>
          )}
        </Card>
        ...
        <div className="xl:col-span-2">
          <div className="mb-4">
            <div className="mb-2 flex items-center justify-between">
              <h2 className="flex items-center gap-2 text-sm font-semibold text-gray-900">
                <MonitorSmartphone size={15} className="text-gray-400" /> Activated Devices ({devices.length})
              </h2>
          ...
          <Card title="History">
            {events.length === 0 ? (
              <p className="py-6 text-center text-sm text-gray-400">No history recorded</p>
            ) : (
      ...
      >
        <div className="space-y-3">
          <p className="text-sm text-gray-600">
            Current expiration: <span className="font-medium text-gray-900">{formatDate(license.expirationDate)}</span>
          </p>
          <Input
